/**
 * Bill detail — rendered as a thermal receipt (pure UI over existing bill
 * data; zero extra storage/network). Share exports a PDF of the receipt.
 */
...
import { fetchBill } from "@/lib/data";
...
export default function BillReceipt() {
  ...
  const q = useCachedQuery(id ? `bill.${id}` : null, () => fetchBill(id!));
      ...
      {q.loading ? (
        ...
        <Card flush>
          <EmptyState
            ...
            message="This bill may not have synced yet."
          />
        </Card>
      ) : (
        <>
