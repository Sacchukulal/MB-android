...
class MirrorTest {
    ...
    @Test fun pages_until_more_is_false_and_keeps_the_cursor() = runTest {
        ...
        val report = mirror.pull(r, setOf("phone.reports"), only = setOf("day_totals"), pageSize = 1)
        ...
        mirror.pull(r, setOf("phone.reports"), only = setOf("day_totals"))
    ...
    @Test fun a_table_the_role_does_not_open_is_skipped_and_the_rest_still_comes() = runTest {
        ...
        val report = mirror.pull(r, setOf("phone.staff"), only = setOf("staff", "menu_items", "bills", "customers"))
    ...
    @Test fun a_tombstone_is_kept_and_hidden() = runTest {
        ...
        mirror.pull(r, setOf("phone.khata"), only = setOf("customers"))
    ...
    @Test fun unreachable_stops_the_pull_and_says_so_once() = runTest {
        server.fail()
        val report = mirror.pull(r, setOf("phone.reports"), only = setOf("day_totals", "bills"))
    ...
    @Test fun bills_keep_their_json_and_their_day() = runTest {
        ...
        mirror.pull(r, setOf("phone.reports"), only = setOf("bills"))
